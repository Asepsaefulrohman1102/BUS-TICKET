...
<head>
  ...
  <title>Ubah Product- NiceAdmin Bootstrap Template</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="assets/img/lbus-solid-1.png" alt="">
    ...
    <section class="section faq">
      <div class="row">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <br>
          <div class="form-group">
            <img src="foto_produk/<?php echo $pecah['foto_produk']; ?>" class="card">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea name="deksripsi" class="form-control" rows="10"><?php echo $pecah['deskripsi_produk']; ?>
						</textarea>
          </div>
