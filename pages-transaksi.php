    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    <div class="card-header">Detail Booking Transaksi</div>
                    <div class="card-body">
                        <form class="row g-3 needs-validation" method="post">

                            <!-- Form Kode Booking -->
                            <div class="md-6">
                                <label class="small mb-1">Kode Booking</label>
                                <div class="card-header"><?php echo $kodeBooking ?></div>
                            </div>

                            <!-- Form Group (first name)-->
                            <div class="md-6">
                                <label class="small mb-1" for="inputFirstName">Nama Pemilik Rekening</label>
                            ...
                            <!-- Form Group (location)-->
                            <div class="md-6">
                                <label class="small mb-1" for="inputLocation">Nomor Rekening</label>
                                <div class="card-header">0987 5637 7245</div>
                            </div>
                            ...
                            <div class="md-6">
                                <label class="small mb-1">Jumlah Transfer</label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text">Rp.</span>
                                    <input type="text" name="jumlah_transaksi" class="form-control" placeholder="300.000">
                                    <div class="invalid-feedback">Tolong Masukkan Jumlah Transaksi Anda.</div>
                                </div>
                            </div>
                            ...
                            <button type="button" class="btn btn-primary" id="liveToastBtn">Simpan</button>
                            <a type="button" class="btn btn-primary" href="pages-profile-booking.php">Kembali</a>
                                ...
                                <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                                    ...
                                    <div class="toast-body">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <a class="btn btn-primary me-md-2" type="button" href="cetak_tiket.php">Cetak Tiket</a>
